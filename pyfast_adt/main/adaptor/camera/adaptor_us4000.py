...
class Cam_us4000(Cam_base):
    ...
    def connect(self):
        ...
        try:
            print("connecting to us400 through temscript")
    ...
    def initialize_detector(self):
        self.name = "CCD"  # spirit otherwise the us4000 should be "CCD"
    ...
    def load_calibration_table(self):
        cwd = os.getcwd()
        path = cwd+os.sep+r"adaptor/camera/lookup_table/us4000_table.txt"
        # table = {"IMAGING", {},
        #          "DIFFRACTION", {}}
...
if __name__ == '__main__':
    cam = Cam_us4000() # to replace CameraEMMENUGPU()
